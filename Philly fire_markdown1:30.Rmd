...
```{r leadingcause, echo=TRUE, cache=TRUE, message=FALSE, warning=FALSE,fig.align='center',fig.height=9, fig.width=13}
...
ggplot() + 
  ...
  geom_sf(data = philly,fill=NA) +
  labs(title= "NO.2 Building Fire, No Collapse") +
  mapTheme(),

ggplot() + 
  geom_sf(data =fire150, colour="#006699", size=0.7) +
  geom_sf(data = philly,fill=NA) +
  labs(title= "NO.3 Outside rubbish fire, Other") +
  mapTheme(),
ncol=3)
```
