...
ggplot() +
  ...
  labs(title = "Fire incidents 2015-2019") +
  mapTheme()
```
...
## What's the trend of the number of fire incidents over time?
...
## What are the spatial units that should be considered?
...
for(i in vars){
  varList[[i]] <- 
    ...
    mapTheme()}
#Plot
do.call(grid.arrange,c(varList, ncol = 2, top = "Local Morans I statistics, Fire incidents in Philadelphia 2015-2019 (P value=0.05"))
```
...
## What are the leading cause of fires?
We made a ranking first based on "incident type":
```{r leadingcause, echo=TRUE, cache=TRUE, message=FALSE, warning=FALSE,fig.align='center',fig.height=8, fig.width=13}
...
### Nearest neighbor distance to hydrants from fires
...
### Feature engineering: Old and Bad hydrants
...
### Correlation: fire, hydrants, old & bad hydrants
...
## Relationship between fire and features
### Zoning type
